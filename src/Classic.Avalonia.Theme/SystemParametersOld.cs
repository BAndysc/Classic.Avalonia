...
// }
        ...
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ActiveBorderColorKey}\">" + SystemColorsOld.ActiveBorderColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ActiveCaptionColorKey}\">" + SystemColorsOld.ActiveCaptionColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ActiveCaptionTextColorKey}\">" + SystemColorsOld.ActiveCaptionTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.AppWorkspaceColorKey}\">" + SystemColorsOld.AppWorkspaceColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ControlColorKey}\">" + SystemColorsOld.ControlColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ControlDarkColorKey}\">" + SystemColorsOld.ControlDarkColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ControlDarkDarkColorKey}\">" + SystemColorsOld.ControlDarkDarkColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ControlLightColorKey}\">" + SystemColorsOld.ControlLightColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ControlLightLightColorKey}\">" + SystemColorsOld.ControlLightLightColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ControlTextColorKey}\">" + SystemColorsOld.ControlTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.DesktopColorKey}\">" + SystemColorsOld.DesktopColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.GradientActiveCaptionColorKey}\">" + SystemColorsOld.GradientActiveCaptionColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.GradientInactiveCaptionColorKey}\">" + SystemColorsOld.GradientInactiveCaptionColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.GrayTextColorKey}\">" + SystemColorsOld.GrayTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.HighlightColorKey}\">" + SystemColorsOld.HighlightColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.HighlightTextColorKey}\">" + SystemColorsOld.HighlightTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.HotTrackColorKey}\">" + SystemColorsOld.HotTrackColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.InactiveBorderColorKey}\">" + SystemColorsOld.InactiveBorderColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.InactiveCaptionColorKey}\">" + SystemColorsOld.InactiveCaptionColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.InactiveCaptionTextColorKey}\">" + SystemColorsOld.InactiveCaptionTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.InfoColorKey}\">" + SystemColorsOld.InfoColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.InfoTextColorKey}\">" + SystemColorsOld.InfoTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.MenuColorKey}\">" + SystemColorsOld.MenuColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.MenuBarColorKey}\">" + SystemColorsOld.MenuBarColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.MenuHighlightColorKey}\">" + SystemColorsOld.MenuHighlightColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.MenuTextColorKey}\">" + SystemColorsOld.MenuTextColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.ScrollBarColorKey}\">" + SystemColorsOld.ScrollBarColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.WindowColorKey}\">" + SystemColorsOld.WindowColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.WindowFrameColorKey}\">" + SystemColorsOld.WindowFrameColor + "</Color>");
        // Console.WriteLine("<Color x:Key=\"{x:Static common:SystemColors.WindowTextColorKey}\">" + SystemColorsOld.WindowTextColor + "</Color>");
        //
